...
/*
immutable: false => prevents the page from being edited
saveCallback: function => called when the page is saved
onChangedCallback: function => called when the page is changed
initialState: init hunks data possibly loaded from moser (see getStaticProps in ../../pages/index.js)
*/
